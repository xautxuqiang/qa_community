...
from .views import (activate, activation_complete, register,
                    registration_closed, registration_complete, validate)
...
urlpatterns = [
    ...
    url(r'^login/$', login, {'template_name': 'users/login.html','redirect_authenticated_user': True}, name='users_login'),
	...
	url(r'^identifying_code/(\d+)/$', validate, name="validate"),
]
